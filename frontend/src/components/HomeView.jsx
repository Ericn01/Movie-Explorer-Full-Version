...
const HomeView = ({setParentMovieMatches}) => {
    ...
    const [isLoading, setIsLoading] = useState(false); // Sets the state of the loading spinner 
            ...
            '> Find All of Your Favorite Movies! </h3>
                <div className="flex-auto my-7"> 
                    <div className='relative'>
                        ...
                        {isLoading ? (<img src="../../public/images/loading.gif" alt="loading image" width={'28px'}/>) : (<img src="images/search.png" width={"28px"} draggable={false}/>)}
                        </div>
